...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-green-50 to-blue-50 text-gray-900 overflow-hidden">
      {/* Desktop Sidebar */}
      <nav className="w-64 bg-white shadow-xl flex-shrink-0 hidden lg:flex lg:flex-col lg:sticky lg:top-0 lg:h-screen border-r border-green-200">
        <Sidebar />
      </nav>
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          <div className="fixed inset-0 bg-green-600 bg-opacity-75" onClick={() => setSidebarOpen(false)} />
          <div className="relative flex w-full max-w-xs flex-1 flex-col bg-white shadow-xl border-r border-green-200">
      ...
      {/* Main Content Area */}
      <div className="flex-1 flex flex-col overflow-hidden min-w-0 bg-gradient-to-br from-green-50 to-blue-50">
